<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admininstrator.aspx.cs" Inherits="PKS.Net.Admininstrator" %>
        ...
        <div id ="menu">
            <table  style="width: 50%; height: 70%; margin:auto">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="ButPol" runat="server" Text="Połączenia" Width="100%" OnClick="ButPol_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="border-right:dotted">
                ...
                <tr>
                    <td class="auto-style1"; style="border-right:dotted">
                        <asp:Button ID="ButAuto" runat="server" Text="Autokary" Width="100%" OnClick="ButAuto_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="border-right:dotted">
                        <asp:Button ID="ButKierowcy" runat="server" Text="Kierowcy" Width="100%" OnClick="ButKierowcy_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="border-right:dotted">
                        <asp:Button ID="ButPas" runat="server" Text="Pasażerowie" Width="100%" OnClick="ButPas_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="border-right:dotted">
                        <asp:Button ID="ButPaswKurs" runat="server" Text="Pasażerowie w Kursach" Width="100%" OnClick="ButPaswKurs_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="border-right:dotted">
                        <asp:Button ID="ButUsers" runat="server" Text="Użytkownicy" Width="100%" OnClick="ButUsers_Click" />
                    </td>
                </tr>
            </table>
        </div>
